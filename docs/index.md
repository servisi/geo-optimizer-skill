...
| [GEO Monitor](geo-monitor.md) | Passive AI-visibility readiness checks for `geo monitor` |
| [GEO Snapshots](geo-snapshots.md) | Archive and query saved AI answer snapshots with citations |
